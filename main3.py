...
filename="/media/anishgt/D_Drive/githububuntu/dbcad/DBCAD/ALDA_dataset_and_initial_code/air.2m.gauss."
f = Dataset(filename+"all.nc", "r+", format="NETCDF4")
